...
public class UnrealTypeInformer {
	...
	UnrealTypeInformer(UnrealName unrealTypeName, Class<?> mappedType, boolean isSingletonStateType,
			boolean isUntypedStruct, Map<UnrealName, Object> arrayElementTypes,
